...
//         crossorigin="anonymous"   // TAMBAHKAN
//         loading="eager"
//         touch-action="none"
...
//       <div className="w-full justify-center gap-6 md:gap-3 absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-wrap items-center pointer-events-auto px-4 max-w-lg">
...
//               initial={{ scale: 0.8 }}
//               animate={{ scale: 1 }}
//               className="w-max bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-3 md:px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm w-full sm:w-auto justify-center"
//             >
...
//               className="w-max bg-gradient-to-r from-red-500 to-pink-600 text-white px-3 md:px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm w-full sm:w-auto justify-center hover:scale-105 cursor-pointer transition-all"
//             >
...
//               animate={{ y: 0, opacity: 1 }}
//               onClick={startAR}
//               className="w-max bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-3 md:px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm w-full sm:w-auto justify-center hover:scale-105 cursor-pointer transition-all"
//             >
...
//           onClick={onBack}
//           className="w-max bg-white/10 backdrop-blur-md border border-white/30 text-white px-3 md:px-4 py-3 rounded-full shadow-xl hover:scale-105 cursor-pointer hover:bg-white/20 transition-all flex items-center gap-2 text-sm mt-2 sm:mt-0"
//         >
...
//           className="w-max relative flex items-center gap-2 px-3 md:px-4 py-3 rounded-full font-bold shadow-xl text-sm bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:scale-105 cursor-pointer transition-all mt-2 sm:mt-0 disabled:opacity-50"
//         >
//           {downloading ? (
//             <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
//           ) : (
...
//             className="w-max bg-gradient-to-r from-purple-500 to-pink-600 text-white px-3 md:px-4 py-3 rounded-full shadow-xl hover:scale-105 cursor-pointer transition-all flex items-center gap-2 text-sm"
//           >
...
//                   className="w-full px-3 md:px-4 py-3 flex items-center gap-3 text-white hover:bg-white/20 transition-all text-sm"
//                 >
...
//                   className="w-full px-3 md:px-4 py-3 flex items-center gap-3 text-white hover:bg-white/20 transition-all text-sm border-t border-white/20"
//                 >
...
export default function ARViewer({ modelUrl, onBack }) {
  ...
  if (!modelUrl || !modelUrl.startsWith('https')) {
    return (
      <div className="flex flex-col items-center justify-center h-screen text-white space-y-6 px-4">
        ...
        <button
          onClick={onBack}
          className="px-6 py-3 bg-cyan-600 rounded-full font-medium hover:scale-105 transition-all flex items-center gap-2"
        >
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen text-white space-y-6 px-4">
        ...
        <div className="text-center max-w-md">
          ...
          <p className="text-sm text-white/70 break-words">{loadError}</p>
          <p className="text-xs text-white/50 mt-2">Cek URL, CORS, atau format file (.glb)</p>
        </div>
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-b from-black via-cyan-950 to-black">
      ...
      {/* Status Bar */}
      <div className="w-full absolute top-4 px-4">
        <div className="max-w-4xl mx-auto backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-4 shadow-2xl pointer-events-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
            ...
            <ul className="text-white/80 hidden md:flex gap-2 text-xs">
              <li className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-md p-1 px-2">
                Putar: 1 jari | Zoom: cubit
              </li>
              <li className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-md p-1 px-2">
                Tekan <strong>Masuk AR</strong> → arahkan ke lantai
              </li>
      ...
      {/* Floating Action Buttons */}
      <div className="w-full max-w-lg mx-auto absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-wrap justify-center gap-3 px-4 pointer-events-auto">
        <AnimatePresence mode="wait">
          {isLoading ? (
            <motion.div
              key="loading"
              initial={{ scale: 0.8 }}
              animate={{ scale: 1 }}
              className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm"
            >
              <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
              Memuat...
            </motion.div>
            ...
            <motion.button
              ...
              animate={{ y: 0, opacity: 1 }}
              onClick={() => window.history.back()}
              className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm hover:scale-105 transition-all"
            >
              <Camera className="w-4 h-4" />
              <span className="hidden md:inline">Keluar AR</span>
            </motion.button>
            ...
            <motion.button
              ...
              animate={{ y: 0, opacity: 1 }}
              onClick={startAR}
              className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-full font-bold shadow-2xl flex items-center gap-2 text-sm hover:scale-105 transition-all"
            >
              <Box className="w-4 h-4" />
              <span className="hidden md:inline">Masuk AR</span>
            </motion.button>
        ...
        <motion.button
          ...
          transition={{ delay: 0.1 }}
          onClick={onBack}
          className="bg-white/10 backdrop-blur-md border border-white/30 text-white p-3 rounded-full shadow-xl hover:scale-105 hover:bg-white/20 transition-all"
        >
          <Home className="w-5 h-5" />
        </motion.button>
        ...
        <motion.button
          ...
          className="relative p-3 rounded-full font-bold shadow-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:scale-105 transition-all disabled:opacity-50"
        >
          {downloading ? (
        ...
        <div className="relative">
          <motion.button
            ...
            transition={{ delay: 0.3 }}
            onClick={() => setShowShareMenu(!showShareMenu)}
            className="p-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-600 text-white shadow-xl hover:scale-105 transition-all"
          >
