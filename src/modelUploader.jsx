...
//                       <g transform="translate(60, 52)" filter="url(#polyGlow)" className="animate-micro-pulse">
//                         <path d="M0,-28 L24,14 L-24,14 Z" fill="url(#polyGradient)" opacity="0.95"/>
//                         <path d="M0,-28 L24,14 L0,28 Z" fill="#22d3ee" opacity="0.75"/>
//                         <path d="M0,-28 L-24,14 L0,28 Z" fill="#06b6d4" opacity="0.7"/>
//                         <path d="M-24,14 L24,14 L0,28 Z" fill="url(#polyGradient)" opacity="0.85"/>
//                       </g>
//                     </svg>
//                   </div>
//                 </div>
...
//             .animate-spin-3d-dynamic { animation: spin-3d-dynamic 20s linear infinite; }
//             .animate-micro-pulse { animation: micro-pulse 3s ease-in-out infinite; }
//             .animate-text-float { animation: text-float 4s ease-in-out infinite; }
//             .animate-subtle-scan { animation: subtle-scan 8s linear infinite; }
//           `,
//         }}
//       />
//     </>
