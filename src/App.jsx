...
function App() {
  const { unityProvider, isLoaded, loadingProgression } = useUnityContext({
    ...
    dataUrl: "/unity-build/Build/3dfc59c974755dee151d250cb020d8bd.data.unityweb", // atau .data
  ...
  return (
    <div style={{ padding: 20, textAlign: 'center' }}>
      <h2>AR dari Tim Unity</h2>
      <p>Arahkan kamera ke target (tanya tim Unity gambarnya apa)</p>
      ...
      <div style={{ maxWidth: 600, margin: '20px auto' }}>
        <Unity unityProvider={unityProvider} style={{ width: '100%', height: 400 }} />
      </div>

      <small>Buka di HP + Chrome + HTTPS</small>
    </div>
  );
}
